        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              // أزرار التفاعل: Chat, Wishlist, Share باستخدام ToggleIconButton
              Padding(
        ...
        Row(
          children: [
            ...
            InkWell(
              ...
              child: Row(
                children: [
                  const Icon(Icons.thumb_down, size: 16, color: Colors.grey),
                  const SizedBox(width: 5),
                  Text(thumbsDown.toString()),
                ],
              ),
            ),
          ],
